---
title: "Self-Hosted ESPs"
description: "Self-hosted and SES-connected email marketing platforms you can run on your own infrastructure."
keywords:
  ...
  - listmonk
  - sendy
sidebar_label: "Self-Hosted ESPs"
sidebar_position: 3
...
audience:
  ...
  - founders
seo:
  title: "Self-Hosted ESPs | Awesome Email Marketing"
  description: "Self-hosted and SES-connected email marketing platforms you can run on your own infrastructure."
  robots: index,follow
  canonical_path: "/docs/tools/self-hosted-esp"
  og_type: article
  twitter_card: summary_large_image
---
# Self-Hosted ESPs

Self-hosted and SES-connected email marketing platforms you can run on your own infrastructure.

Related: [Open Source Tools](./open-source-tools).
